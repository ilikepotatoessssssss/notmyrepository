...
Command.setDescription('Eval code')
...
// Start
    ...
    const code = message.content.replace(".eval", "").replace("w!eval", "");
    if (code.match(/client.token/gi) && !client.developer) {
        return message.channel.send("[Spark] Using this code could give other people access to your bot. If you know what you're doing, you can enable developer mode for this session by typing `.developer true`. \n**ONLY USE THIS IF YOU KNOW WHAT YOU ARE DOING!!**")
    }
    ...
    if (code.match(/no-preserve-root/gi) && !client.developer) {
        return message.channel.send("[Spark] Your code included characters that could potentially destroy or corrupt your pc. I have stopped execution. |  If you know what you're doing, you can enable developer mode for this session by typing `.developer true`. \n**ONLY USE THIS IF YOU KNOW WHAT YOU ARE DOING!!**")
    }
// End
// Trying to prevent people from destroying their computer / bot / discord account.
//
